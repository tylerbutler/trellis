...
[tools.trellis.publish]
tag_format = "{name}-v{version}"          # lat_core-v1.2.0
series_tag_format = "{name}-v{series}"    # lat_core-v1, lat_cli-v0.4
...
A package tags in one of two lifecycles, chosen by `tag_mode`:
